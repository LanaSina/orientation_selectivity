...
Read and plot all processed data for single pixels?
...
for(experiment in folders){
  ...
  df = read.csv(fileName)
  pByDistance = df
  allData[[i]] = pByDistance
}

#plot here

pdf("single_pixel_greyscale.pdf", width=6, height=4) 
plot()
legend(x = 10, y = 0.8, legend=c("Line 1", "Line 2"),
